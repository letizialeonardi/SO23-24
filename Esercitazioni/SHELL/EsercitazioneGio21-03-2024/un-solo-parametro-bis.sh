...
#come fatto nel file un-solo-parametro1.sh il controllo sul numero di parametri invece che con un if puo' essere fatto con un case
  ...
  /*) echo "$1 e' un nome assoluto" 		#solo se inizia con il carattere / e' un nome assoluto
      ...
      then echo "$1 e' il nome di un file"
	   ...
	   then echo "$1 e' il nome di una directory traversabile" 
           else echo $1 non file o non directory	#non e' un file o una directory; come commentato in un altro script questa e' una evenienza molto rara!
      	   fi 
      fi;;
