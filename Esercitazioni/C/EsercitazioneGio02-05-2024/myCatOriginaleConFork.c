...
int main (int argc, char** argv)
{
   ...
   int ritorno;         /* per filtrare valore di uscita del figlio  */
	...
	/* controlliamo che si passi esattamente un parametro che deve essere un nome di file da visualizzare! */
   	if (argc != 2)
	{
	...
	{ /* figlio */
	   int fd;
		...
		printf("DEBUG-Esecuzione di programma che visualizza file gia` aperto con il comando-filtro cat\n");
		execlp("cat", "cat", (char *)0);	/* unica modifica rispetto al file myCatConFork.c */
