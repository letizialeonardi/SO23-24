...
{
   int casuale;
	casuale = rand() % n;	/* con rand() viene calcolato un numero pseudo-casuale e con l'operazione modulo n si ricava un numero (sempre pseudo-)casuale compreso fra 0 e n-1 */
	return casuale;
}
