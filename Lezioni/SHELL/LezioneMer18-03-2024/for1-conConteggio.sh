...
do
	...
	echo Sono all\'iterazione numero $cont	#stampiamo il valore del contatore; ATTENZIONE: se vogliamo usare l'apostrofo e non vogliamo usare le doppie virgolette dobbiamo usare il carattere di escape
