#!/bin/sh
x='ls -l $z'	#assegniamo valore alla variabile x facendo uso dei singoli apici sia per inibire le sostituzioni (in questo caso la prima) e sia per inserire degli spazi!
z=provaSost.sh	#assegniamo valore alla variabile z
